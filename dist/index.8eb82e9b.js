...
})({"fZ9dR":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
const $button2 = _jqueryDefault.default("#dec");
const $button3 = _jqueryDefault.default("#mul");
const $button4 = _jqueryDefault.default("#divide");
const $number = _jqueryDefault.default("#number");
const $reset = _jqueryDefault.default("#reset");
...
},{"jquery":"bE6My","@parcel/transformer-js/src/esmodule-helpers.js":"9r9wd","./app1.css":"cNEhT"}],"bE6My":[function(require,module,exports) {
/*!
...
},{}],"9r9wd":[function(require,module,exports) {
...
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const $tabBar = _jqueryDefault.default('.tab-bar');
const $tabContent = _jqueryDefault.default('.tab-content');
$tabBar.on("click", "li", (e)=>{
    const $li = _jqueryDefault.default(e.currentTarget);
    const n = $li.index();
    $tabBar.children().eq(n).addClass('selected').siblings().removeClass('selected');
    $tabContent.children().eq(n).addClass('active').siblings().removeClass('active');
});
$tabBar.children().eq(0).trigger('click');

},{"jquery":"bE6My","@parcel/transformer-js/src/esmodule-helpers.js":"9r9wd","./app2.css":"2POXe"}],"2POXe":[function() {},{}],"39DIW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"jquery":"bE6My","@parcel/transformer-js/src/esmodule-helpers.js":"9r9wd","./app3.css":"6afT9"}],"6afT9":[function() {},{}],"jOilj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"jquery":"bE6My","@parcel/transformer-js/src/esmodule-helpers.js":"9r9wd","./app4.css":"dmc4x"}],"dmc4x":[function() {},{}]},["fZ9dR","iJDgK"], "iJDgK", "parcelRequiredcee")
